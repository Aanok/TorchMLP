...
local training = {}
training[1], training[2] = parse_monks("../monks/monks-3.train")
training.name = "monks-3.train"

local test = {}
test[1], test[2] = parse_monks("../monks/monks-3.test")
test.name = "monks-3.test"
...
local trace = {}
for _,lr in ipairs({10,5,1,0.5,0.1}) do
...
gnuplot.epsfigure("monks-3_error.eps")
gnuplot.raw('set title "Monks-3" font ",20"')
...
gnuplot.plotflush()
gnuplot.epsfigure("monks-3_accuracy.eps")
